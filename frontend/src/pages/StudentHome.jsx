    ...
    <div className="max-w-4xl mx-auto p-6 animate-fade">
      <div className="student-hero-card">
        ...
        <div className="main-btn-grid">
          ...
          <button onClick={() => navigate(`/progress?student=${selectedStudent}`)} className="big-action-btn secondary">
            <span className="tag" style={{ background: 'rgba(4,56,42,0.15)', padding: '4px 10px', borderRadius: '999px', fontSize: '12px', fontWeight: 700, display: 'inline-block' }}>Progress</span>
            <h3>📊 View Progress</h3>
            <p>See your improvement over time with charts and history.</p>
          </button>
        </div>
